...
<div>
	<img src="images/logoacademy2.png" alt="Acme-Academy-2.0 Co., Inc." />
</div>
...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					...
					<li><a href="bibliography/administrator/list.do"><spring:message code="master.page.lecturer.bibliography.list" /></a></li>					
				</ul>
			</li>
		</security:authorize>
		...
		<security:authorize access="hasRole('LECTURER')">
			<li><a class="fNiv"><spring:message	code="master.page.lecturer" /></a>
				<ul>
					...
					<li><a href="rubric/lecturer/create.do"><spring:message code="master.page.lecturer.rubric.create" /></a></li>
		...
		<security:authorize access="hasRole('LECTURER')">
			<li><a class="fNiv"><spring:message	code="master.page.bibliography" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="bibliography/lecturer/list.do"><spring:message code="master.page.lecturer.bibliography.list" /></a></li>
					<li><a href="bibliography/lecturer/create.do"><spring:message code="master.page.lecturer.bibliography.create" /></a></li>				
				</ul>
			</li>
		</security:authorize>
		
		<security:authorize access="hasRole('LECTURER')">
			<li><a class="fNiv"><spring:message	code="master.page.syllabi" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="syllabus/lecturer/list.do"><spring:message code="master.page.lecturer.syllabus.list" /></a></li>
					<li><a href="syllabus/lecturer/create.do"><spring:message code="master.page.lecturer.syllabus.create" /></a></li>				
				</ul>
			</li>
		</security:authorize>
