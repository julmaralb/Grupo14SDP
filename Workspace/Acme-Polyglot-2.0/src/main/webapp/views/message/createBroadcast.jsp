...
<form:form action="message/actor/createBroadcast.do" modelAttribute="messa">
	<form:hidden path="id"/>
	...
	<input type="hidden" name= "languageExchangeId" value="${languageExchangeId}"/>
	
	<acme:submit name="broadcast" code="message.send"/>
