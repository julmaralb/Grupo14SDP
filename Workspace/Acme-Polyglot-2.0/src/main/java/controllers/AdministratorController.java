...
public class AdministratorController extends AbstractController {
	...
	public ModelAndView dashboard() {
		...
		Collection<Object[]> ratioLaguagesMessages;
		...
		meanMinMaxMessagesPerFolder = administratorService
				.meanMinMaxMessagesPerFolder();
		ratioLaguagesMessages = administratorService.ratioLaguagesMessages();
		...
		result.addObject("avgMinMaxSponsoredExchangesPerPolyglot",
				avgMinMaxSponsoredExchangesPerPolyglot);
		result.addObject("meanMinMaxMessagesPerFolder",
				meanMinMaxMessagesPerFolder);
		result.addObject("ratioLaguagesMessages", ratioLaguagesMessages);
