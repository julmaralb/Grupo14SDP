...
public class LecturerServiceTest extends AbstractTest {
	...
	/**
	 * 6.2 An actor who is not authenticated must be able to:
	 * 		- List the lecturers and navigate to the subjects that they teach.
	 * 
	...
	public void testListLecturer1() {
		...
		Assert.isTrue(lecturers.size()==3,"El numero de Lecturer no coincide");
		Assert.isTrue(subjects.size()==4,"El numero de subjects no coincide");
		
	}
	
	/**
	 * 7.1 An actor who is authenticated must be able to:
	 * 		- Perform the same actions as an actor who is not authenticated, 
	 * 			except for registering to the system.
	 * 
	 * Positive Test: Listar los lecturer y navegar hasta los subjects
	 */
	@Test 
