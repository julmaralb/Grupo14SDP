...
public class GroupServiceTest extends AbstractTest {
	...
	/**
	 * 8.2 An actor who is authenticated as a lecturer must be able to:
	 * 		- Create a group of students and associate it with a subject.
	 * 
	 ...
	 */
		...
		public void testCrearGroup1() {
			...
			Assert.isTrue(groupService.findAll().size()== before+1,"El grupo no se ha guardado");
	}
		 ...
		 */
			 ...
			 * 		- Create a group of students and associate it with a subject.
			 * 
			 * Negative Test: Un lecturer crea un group sin academicYear y le asigna un subject
			 */
				...
				/**
				 * 9.1 An actor who is authenticated as a student must be able to:
				 * 		- Enrol a group of students so that he or she becomes a member of that group.
				 * 
