...
public class ChargeRecordServiceTest extends AbstractTest{
				...
				public void TestListarChargeRecord1(){
					...
					chargeRecords.addAll(chargeRecordService.findAllByCreditCardIdAndPrincipal(c.getId()));
					}
					
					Assert.isTrue(chargeRecords.size()==4,"El número de ChangeRecord no coincide");
				}
