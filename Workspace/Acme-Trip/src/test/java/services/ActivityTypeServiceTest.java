...
public class ActivityTypeServiceTest extends AbstractTest {
	...
	/**
	 * Requirement: An actor who is not authenticated must be able to: - List
	 * the types of activities that are registered in the system and navigate to
	 * the trips that involve them.
	 * 
	...
	public void TestModifyActivityType() {
		...
		Assert.isTrue(!name.equals(activityType.getName()),
