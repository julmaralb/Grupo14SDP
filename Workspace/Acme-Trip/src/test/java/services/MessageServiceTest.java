...
public class MessageServiceTest extends AbstractTest {
	 ...
	 * 
	 * Positive Test: Borrar un mensaje que está en una carpeta que no es Trash
	 * Folder.
	 */
	@Test
	public void testDeleteMessage() {
		...
		Assert.isTrue(message.getFolder().getName().equals("Trash Folder"),
				"El mensaje no se ha movido a Trash Folder");
		unauthenticate();
	}
